...
def findConcentrationsAbstract(distToUnknown, componentCount, makeMixture, startConcentrations=None, fixConcentrations=None, trysCgenerateMixtureOfSampleount=1):
    """
    Concentration search
